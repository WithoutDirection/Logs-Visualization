"""
Django settings for LogViz project.
...
SECRET_KEY = 'django-insecure-9zererlf=4q3iktc7kjdh-!a4)xld)e0x#*293524d0pa%-^$%'
...
WSGI_APPLICATION = 'LogViz.wsgi.application'
