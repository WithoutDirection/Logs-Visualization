...
class Visualization {
    ...
    async createNetworkVisualization(data) {
        if (!data) {
            console.warn('⚠️ createNetworkVisualization: No data provided');
            return;
        }
    ...
    const startTime = performance.now();
        ...
        console.log('🎨 Creating visualization:', { nodeCount, edgeCount });
        ...
        if ((nodeCount === 0) || (edgeCount === 0)) {
            ...
            console.warn('🚫 No nodes/edges to render:', { nodeCount, edgeCount });
            return;
        }
        ...
        if (noGraphMessage) {
            console.log('🗑️ Removing .no-graph placeholder');
        ...
        try {
            ...
            if (this.network) {
                ...
                console.log('✅ vis.Network created:', !!this.network);
